...
interface ForgotEmailOtpStepProps {
  email: string;
  onVerified: () => void;
}
...
export default function ForgotEmailOtpStep({ email, onVerified }: ForgotEmailOtpStepProps) {
  ...
  async function handleVerify(fullCode: string) {
    ...
    setVerifying(true);
    try {
      await authService.verifyEmailResetOtp(email, fullCode);
      haptics.success();
      onVerified();
    } catch (err) {
